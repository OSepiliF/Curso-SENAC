...
-- select * from senso where estado = 'Mato Grosso do Sul' and nome_mun = 'Campo Grande' or nome_mun = 'Terenos';
...
-- select * from senso where nome_mun = 'Campo Grande' order by populacao desc limit 5;
...
-- select * from senso where estado like '_a%';
