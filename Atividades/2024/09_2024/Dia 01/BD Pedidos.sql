...
select nomevend from vendedor order by salario asc limit 1;
...
select descricao from produto order by valor_un desc limit 1; 

-- 13. Qual o produto mais caro? 
select descricao from produto order by valor_un asc limit 1;

-- 14. Quantos vendedores existem no setor de ferramentas? 
select count(nomevend) from vendedor where codsetor = 4;
